...
public class StairClimbActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stair_climb);
    }
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise e = new Exercise("Stair Climb", 1, 5);
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Stair Climb", 2, 5);
        CalorieCounterActivity.exercises.add(e);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Stair Climb", 3, 5);
        CalorieCounterActivity.exercises.add(e);
    }
}