...
public class BicepsCurlActivity extends AppCompatActivity {
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise bicepCurls = new Exercise("Bicep Curls", 1, 10);
        CalorieCounterActivity.exercises.add(bicepCurls);
    }
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise bicepCurls = new Exercise("Bicep Curls", 2, 10);
        CalorieCounterActivity.exercises.add(bicepCurls);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise bicepCurls = new Exercise("Bicep Curls", 3, 10);
        CalorieCounterActivity.exercises.add(bicepCurls);
    }
}