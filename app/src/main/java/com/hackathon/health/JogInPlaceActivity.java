...
public class JogInPlaceActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jog_in_place);
    }
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise e = new Exercise("Jogging", 1, 0);
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Jogging", 2, 0);
        CalorieCounterActivity.exercises.add(e);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Jogging", 3, 0);
        CalorieCounterActivity.exercises.add(e);
    }
}