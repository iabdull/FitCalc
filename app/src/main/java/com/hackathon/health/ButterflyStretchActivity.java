...
public class ButterflyStretchActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_butterfly_stretch);
    }
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise e = new Exercise("Butterfly Stretch", 1, 0);
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Butterfly Stretch", 2, 0);
        CalorieCounterActivity.exercises.add(e);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Butterfly Stretch", 3, 0);
        CalorieCounterActivity.exercises.add(e);
    }
}