...
public class JumpRopeActivity extends AppCompatActivity {

    public static final String TIMERLEVEL = null;
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise e = new Exercise("Jumprope", 1, 0);
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Jumprope", 2, 0);
        CalorieCounterActivity.exercises.add(e);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Jumprope", 3, 0);
        CalorieCounterActivity.exercises.add(e);
    }
}