...
public class SquatsCalActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_squats_cal);
    }
    ...
    public void toLevelOneActivity(View view){
        ...
        Exercise e = new Exercise("Squats", 1, 10);
    ...
    public void toLevelTwoActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Squats", 2, 10);
        CalorieCounterActivity.exercises.add(e);
    }
    ...
    public void toLevelThreeActivity(View view){
        ...
        intent.putExtras(bundle);
        startActivity(intent);
        Exercise e = new Exercise("Squats", 3, 10);
        CalorieCounterActivity.exercises.add(e);
    }
}